...
const API_BASE_URL = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
 ...
 commentary.push(`🎯 Great win rate at ${winRate.toFixed(1)}%, but watch position sizing - winners aren't big enough to losers.`);
 ...
 <div className="relative flex-shrink-0"><div className="absolute inset-0 bg-green-400/20 rounded-full group-hover/item:opacity-100"></div><span className="relative text-2xl text-green-400 font-bold">✓</span></div>
 ...
 >
 <span className="group-hover:-translate-x-1">←</span><span>Back to Plans</span>
 </button>
 ...
 <h2 className="relative text-2xl font-black text-transparent bg-clip-text bg-gray-800 mb-4" >🔍 Stock Search</h2>
 ...
 <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gray-800 mb-4 mt-8">📊 Select a Stock to Trade</h3>
 ...
 <div className="flex items-center gap-2">
 <h3 className="text-sm font-black text-transparent bg-clip-text bg-gray-800 to-blue-400">📈 Price Chart</h3>
 {isRealChartData ? (
 ...
 <div className="space-y-2">
 <p className="text-purple-200 font-semibold">🧠 Initializing neural networks...</p>
 <p className="text-purple-300 text-sm delay-100">📊 Analyzing technical indicators...</p>
 <p className="text-purple-300 text-sm delay-200">📰 Processing news sentiment...</p>
 <p className="text-purple-300 text-sm delay-300">⚡ Calculating risk factors...</p>
 </div>
 </div>
 </div>
 )}
 ...
 <div className="space-y-3">
 <p className="text-purple-200 font-bold text-xl">🧠 Initializing neural networks...</p>
 <p className="text-purple-300">📊 Analyzing technical indicators...</p>
 <p className="text-purple-300">📰 Processing news sentiment...</p>
 <p className="text-purple-300">⚡ Calculating risk factors...</p>
 <p className="text-purple-300">🎯 Generating trade recommendations...</p>
 </div>
 </div>
 </div>
 )}
 ...
 © 2025 <span className="text-transparent bg-clip-text bg-gray-800 font-black">FinClash</span>. All rights reserved.
 </p>
 <p className="text-gray-500 text-sm font-semibold">
